...
import { UserAvatar } from '@/components/slack/users/user-avatar'
import { Badge } from '@/components/ui/badge'
import { LoadingSpinner } from '@/components/slack/common/loading-spinner'
import { useToast } from '@/hooks/use-toast'
import { ChannelMembersDialogProps } from '@/types/components'
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          ...
          action: undefined // Remove variant and use action instead if needed
        })
      }
    } catch (err) {
