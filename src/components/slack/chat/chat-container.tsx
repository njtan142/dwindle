...
import { ChannelsPanel } from '@/components/slack/channels/channels-panel'
import { ChatHeader } from '@/components/slack/chat/chat-header'
import { MessageInput } from '@/components/slack/chat/message-input'
import { MembersPanel } from '@/components/slack/users/members-panel'
import { MessageList } from '@/components/slack/chat/message-list'
import { QuickSwitcher } from '@/components/slack/navigation/quick-switcher'
    ...
    <div className="flex h-screen w-full bg-gray-100" ref={chatContainerRef}>
      ...
      {isChannelsPanelOpen ? (
        <ChannelsPanel
          ...
          channels={channels as ChannelForComponent[]}
